...
import { solveStructure as solve } from '../services/solve.js'
...
export const debouceParse = debounce((lines) => {
	...
	appState.structure = parsedStructure
	appState.errors = parseErrors

	// When the structure has changed, the solution should be cleared
	appState.solution = null
}, 500)

export async function solveStructure() {
	// TODO: try-catch errors
	appState.isLoading = true
	try {
		appState.solution = await solve(appState.structure, appState.lines)
	} catch (e) {
		console.error(e)
	} finally {
		setTimeout(() => {
